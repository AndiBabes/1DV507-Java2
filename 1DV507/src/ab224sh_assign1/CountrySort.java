...
public class CountrySort
{
	...
	public static void main(String[] args)
	{
		...
		// a).
		// I used an external library that I found on the internet to help me count the
		// occurrences of the letter 'a'
		// (http://commons.apache.org/proper/commons-lang/)
		Comparator<String> countAs = (s1, s2) -> Integer.compare(
				StringUtils.countMatches(s2, 'a') + StringUtils.countMatches(s2, 'A'),
				StringUtils.countMatches(s1, 'a') + StringUtils.countMatches(s1, 'A')); // Must be updated
